...
class SimpleFormWidgetState extends State<SimpleFormWidget> {
  ...
  void saveDriveDetails() async {
    ...
    VaccineDrive drive = VaccineDrive(driveForm?['driveName'], driveForm?['driveDate']);
    drive.isPreApproved = driveForm?['isPreApproved'];
    drive.addVaccineDetails(vaccineName: 'Covaxine', doses: int.parse(driveForm?['covaxineDoses']));
    drive.addVaccineDetails(vaccineName: 'Covishield', doses: int.parse(driveForm?['covishieldDoses']));
